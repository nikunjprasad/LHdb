    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="warden.html"><span class="glyphicon glyphicon-home"></span><b> Home</b></a></li>                <!--change this to security.html -->
       ...
       <li class="dropdown">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
            <li><a href="viewstud1.php">Student</a></li>
            <li><a href="viewsecurity.php"><b>Security</b></a></li>
...
{
        echo "<table>"; 
        echo "<tr><th>Name</th><th>SecurityID</th><th>PhoneNo</th><th>Gate</th></tr>";
        while($row=$result->fetch_assoc())
        {  
                echo "<tr><td>" . $row['Name'] . "</td><td>". $row['SecurityID'] . "</td><td>". $row['PhNo'] . "</td><td>". $row['Gate'] . "</td></tr>";  
        }
        echo "</table>"; 
}
else
